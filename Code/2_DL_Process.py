...
# %% Lib and sys
from central import (MLP, RBFNet, DataModule,
...
np.savetxt(wk_dir + "Output/dl_Matern_02_1_09.csv", dl_mse, delimiter=",")
np.savetxt(wk_dir + "Output/kr_Matern_02_1_09.csv", kr_mse, delimiter=",")
# %% Process 3
...
np.savetxt(wk_dir + "Output/dl_P3.csv", dl_mse, delimiter=",")
np.savetxt(wk_dir + "Output/kr_P3.csv", kr_mse, delimiter=",")
...
np.savetxt(wk_dir + "Output/dl_P4.csv", dl_mse, delimiter=",")
np.savetxt(wk_dir + "Output/kr_P4.csv", kr_mse, delimiter=",")
...
np.savetxt(wk_dir + "Output/dl_P5.csv", dl_mse, delimiter=",")
np.savetxt(wk_dir + "Output/kr_P5.csv", kr_mse, delimiter=",")
# %%
